...
import mplleaflet  # Import the mplleaflet library
...
def main():
    ...
    ax1 = fig.add_subplot(1, 2, 1, projection=ccrs.Orthographic(15, 70))
    ...
    for ax in [ax1, ax2]:
        ...
        ax.stock_img()
        # Use Stamen Terrain as a satellite-like basemap
        ax.add_image(Stamen('terrain-background'), 5, alpha=0.0)
        ax.gridlines()
...
if __name__ == '__main__':
    ...
    plt.savefig('aurora_plot5.png', dpi=300, bbox_inches='tight')